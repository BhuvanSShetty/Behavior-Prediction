...
export default function AlertsPage() {
  ...
  return (
    <div className="flex-1 overflow-auto p-6 space-y-6">
      ...
      {alerts.length === 0 && (
        <div className={`${styles.card} text-center py-20 border border-dashed border-surface-variant/50`}>
      ...
      <div className="space-y-4 max-w-4xl">
        {alerts.map(alert => {
          ...
          return (
            <div key={alert.id} className={`${styles.card} border ${meta.color} flex items-start gap-5 hover:border-surface-variant/80 transition-all transform hover:-translate-y-0.5`}>
